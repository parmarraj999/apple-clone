...
Command: npx gltfjsx@6.2.16 iphone-blue.gltf 
*/

import React, { useRef } from 'react'
import { useGLTF } from '@react-three/drei'

export function IphoneBlue(props) {
  const { nodes, materials } = useGLTF('./assets/iphone-blue.gltf')
  return (
...
useGLTF.preload('/iphone-blue.gltf')
