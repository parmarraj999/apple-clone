...
Command: npx gltfjsx@6.2.16 iphone-white.gltf 
*/

import React, { useRef } from 'react'
import { useGLTF } from '@react-three/drei'

export function IphoneWhite(props) {
  const { nodes, materials } = useGLTF('./assets/iphone-white.gltf')
  return (
    <group {...props} dispose={null}>
      ...
      <mesh geometry={nodes.white.geometry} material={materials.white} position={[0.03, 0.731, 0.858]} rotation={[Math.PI / 2, 0, -0.001]} scale={[8.956, 4.253, 6.652]} />
    </group>
  )
}

useGLTF.preload('/iphone-white.gltf')
